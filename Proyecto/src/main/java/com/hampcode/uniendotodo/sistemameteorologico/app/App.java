package com.hampcode.uniendotodo.sistemameteorologico.app;
...
import com.hampcode.uniendotodo.sistemameteorologico.model.RegistroDatos;
import com.hampcode.uniendotodo.sistemameteorologico.model.TemperaturaHora;
import com.hampcode.uniendotodo.sistemameteorologico.service.ServicioClimatologia;
import com.hampcode.uniendotodo.sistemameteorologico.util.Init;
import com.hampcode.uniendotodo.sistemameteorologico.util.PrintUtil;
...
public class App {
	...
	private static void maximaYMinimaTotal() {
		...
		// Nos aseguramos bien que el valor de Optional está presente
		if (maxima.isPresent())
