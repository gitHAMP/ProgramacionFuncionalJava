package com.hampcode.apistream.datoscalculos;
...
public class B_Datos {
	public static void main(String[] args) {
		...
		List<String> listaPalabrasLargas = Arrays.asList("Arteriosclerosis", "Bioelectromagnetismo",
				"Ciclopentanoperhidrofenantreno", "Magnetoencefalografía", "Neurorretroalimentación");
