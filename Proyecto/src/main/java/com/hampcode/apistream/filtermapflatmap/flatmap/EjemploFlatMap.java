...
public class EjemploFlatMap {
	...
	public static void main(String[] args) {
		...
		// ¿Cómo podríamos hacer para identificar los paieses diferentes? 
		...
		// Para los tipos de datos primitivos, también tenemos sus versiones
		// flatMapToXXX
		// Si tan solo los queremos unificar, podemos usar la función
		// Function.identity()
