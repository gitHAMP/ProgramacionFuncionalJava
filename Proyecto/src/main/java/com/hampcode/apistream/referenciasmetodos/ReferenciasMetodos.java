package com.hampcode.apistream.referenciasmetodos;
...
public class ReferenciasMetodos {
	...
	public static void main(String[] args) {
		...
		List<Estudiante> estudiantes = personas.stream().filter(p -> p.getEdad() <= 18).map(p -> p.getNombre())
				.map(Estudiante::new).collect(Collectors.toList());
